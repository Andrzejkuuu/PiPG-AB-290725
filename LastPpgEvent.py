...
#oraz zabezbieczenie sie na wypadek bialych znakow i innych niepotrzebnych znakow
index = query.index('=')
objectField = query[:index].strip()
objectID = query[index+1:].strip().strip('\'')

#wyselekcjonowanie wskazanego obiektu na podstawie zapytania SQL
...
#utworzenie DataFrame z wynikowymi informacjami
